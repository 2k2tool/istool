        ...
        if ($('#username-input').val() != '') {
            if ($selected_platform != '') {
				...
				$('#csr-generator').fadeOut(700, function() {
					...
					sweetAlert("Error", "المرجو منك اختيار كمية الفيبوكس التي تريدها", "error");
				}	
            } else {
                sweetAlert("Error", "المرجو منك اختيار المنصة التي تلعب عليها", "error");
            }
        } else {
            sweetAlert("Error", "المرجو منك إدخال اسمك في اللعبة", "error");
        }        
    });
